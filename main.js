...
class RecallKnowledge {
  ...
  static async handleOutcome(targetActor, rollingActor, skillSlug, dc, outcome, rollingUser) {
    ...
    if (outcome === "criticalFailure") {
      ...
      const text =
        lore.falseInfo ||
        "You recall something about this creature... and you're certain of it. (No false lore has been set for this creature — improvise something plausible but wrong.)";
